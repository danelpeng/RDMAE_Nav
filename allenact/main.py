...
def get_args():
    ...
    parser.add_argument(
        ...
        "--experiment", 
        type=str, 
        default="pointnav_robothor_vanilla_rgb_rdmae_ddppo", 
        required=False,
    ...
    parser.add_argument(
        ...
        "--extra_tag",
        type=str,
        default="rnav_pointnav_vanilla_rgb_rdmae_ddppo_clean",#单步调试暂时指定
        required=False,
    ...
    parser.add_argument(
        ...
        required=False,
        type=str,
        default="storage/robothor-pointnav-rgb-rdmae-ddppo",#单步调试暂时指定
    ...
    parser.add_argument(
        ...
        "--experiment_base",
        required=False,
        default="projects/robustnav/experiments/train",#单步调试暂时指定
        type=str,
